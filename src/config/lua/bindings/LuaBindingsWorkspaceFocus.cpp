...
static int hlFocus(lua_State* L) {
    ...
    auto monStr = Internal::tableOptStr(L, 1, "monitor");
    if (monStr) {
    ...
    auto winStr = Internal::tableOptStr(L, 1, "window");
    if (winStr) {
...
static int hlWorkspace(lua_State* L) {
    if (lua_isstring(L, 1) || lua_isnumber(L, 1)) {
        std::string ws = Internal::argStr(L, 1);
    ...
    auto id               = Internal::tableOptStr(L, 1, "id");
    if (id) {
...
static int hlWorkspaceRename(lua_State* L) {
    ...
    const auto id   = Internal::requireTableFieldNum(L, 1, "id", "hl.workspace.rename");
...
static int hlWorkspaceMove(lua_State* L) {
    ...
    const auto mon = Internal::requireTableFieldStr(L, 1, "monitor", "hl.workspace.move");
...
static int hlWorkspaceSwapMonitors(lua_State* L) {
    ...
    const auto m1 = Internal::requireTableFieldStr(L, 1, "monitor1", "hl.workspace.swap_monitors");
    const auto m2 = Internal::requireTableFieldStr(L, 1, "monitor2", "hl.workspace.swap_monitors");
